#Taller 5 
#Carlo Muñoz Morán - Diego Montero Pagola 
...
islapascua<- rast("capas_rasters/dem_islas/Dem Isla de pascua 4m.tif")  
...
plot(islapascua)
#######archivo J Fernandez
juanfernandez<-rast("capas_rasters/dem_islas/Dem J Fernandez  2m.tif")
