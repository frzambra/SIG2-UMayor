...
##  ¿Cómo utilizar R? {background-image="../img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Tipos de datos {background-image="../img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
:::
::: {.column width="50%}
![](img/r-programming-data-types.png)
:::
:::
...
# 3. Estructura de datos {background-color='darkgreen'}

## Estructuras de datos {background-image="../img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Vectores con atributos {background-image="../img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
# 4. Tipos de datos derivados {background-color='lightblue'}
...
# 5. Estructura de datos {background-color='darkgreen'}
...
## Algunas cosas importantes {background-image="../img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
