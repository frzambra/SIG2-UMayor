...
data_info<- read.csv2('estaciones_agromet.csv')
...
#un resumen de la estructura con
str(data)

#funciones para inspeccionar
head(data) #primeras seis filas
tail(data) #últimas seis filas
...
#calcula de temperatura maxima sin considerar los NA
max(data_temp_enero2$temp_maxima,na.rm=TRUE)

##calcula de temperatura minima sin considerar los NA
min(data_temp2$temp_minima,na.rm = TRUE)

#calcula de temperatura promedio sin considerar los NA
