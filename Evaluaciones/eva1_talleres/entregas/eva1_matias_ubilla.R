...
tempair <-data$temp_promedio_aire
tempmin <- data$temp_minima
tempmax <-data$temp_maxima
...
max(data_temp_2$temp_maxima,na.rm = T)
min(data_temp_2$temp_minima,na.rm = T)
mean(data_temp_2$temp_promedio_aire,na.rm = T)
