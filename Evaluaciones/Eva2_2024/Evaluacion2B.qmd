---
title: "Evaluación 2: SIG Avanzado (Tipo B)"
...
```{r}
library(sf)
m <- matrix(c(-70.89022, -34.04304,-70.60982, -33.89914,-69.83267, -34.07135,
              -70.07072, -33.08164,-71.01418, -33.03640, -71.54870, -33.76775,-70.89022, -34.04304),
            byrow = TRUE,ncol = 2)
...
poligono_sfc_32719 <- st_transform(poligono_sfc,32719)
plot(poligono_sfc_32719)
plot(buf_30km,add = TRUE)
```

## Pregunta 3

Aplique una operación afin sobre el buffer, para trasladar el buffer 60.000 metros hacia el Oeste y 10.000 metros hacia el Sur. Haga un plot del polígono y el buffer trasladado.

```{r}
poligono_sfc <- st_sfc(poligono,crs = 4326)
poligono_32719 <- st_transform(poligono_sfc,32719)
buf_30km_tras <- buf_30km + c(-60000,-10000)
plot(poligono_32719)
