...
## ¿Qué hemos visto hasta el momento? {.smaller background-image="../img/R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## Contenidos clase {.smaller background-image="../img/R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## 1. Manejo de CRS en R {.smaller background-image="../img/R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## 2. Datos vectoriales: `{sf}` {.smaller background-image="../img/logo_sf.gif" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## 3. Datos raster: `{terra}` {.smaller background-image="../img/logo_sf.gif" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## 3. Datos raster: `{terra}` {.smaller background-image="../img/logo_terra.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## Recomendación {.smaller background-image="../img/R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
