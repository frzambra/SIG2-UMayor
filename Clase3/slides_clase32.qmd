...
## ¿Con qué vamos a trabajas? {.smaller background-image="../img/logo_terra.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
##  {terra} {.smaller background-image="../img/logo_terra.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## Crear un `SpatRaster` {.smaller background-image="../img/logo_terra.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## Crear un `SpatRaster` multi-capa {.smaller background-image="../img/logo_terra.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## Vectoriales {.smaller background-image="../img/logo_sf.gif" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## Rasters  {.smaller background-image="../img/logo_terra.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
