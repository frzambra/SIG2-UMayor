...
## 1. Evolución de paquetes espaciales {.smaller background-image="../img/R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}

![](../img/spatial_packages.png)

## 2. Antecedentes {.smaller background-image="../img/R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## 3. Paquetes de R-Spatial {.smaller background-image="../img/R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## Paquetes de R-Spatial {.smaller background-image="../img/R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
